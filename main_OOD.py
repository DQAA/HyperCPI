...
if __name__ == "__main__":
    ...
    compounds_train, adjacencies_train, proteins_train, interactions_train = load_dataset('GPCR/train')
    compounds_test, adjacencies_test, proteins_test, interactions_test = load_dataset('kinase/test')
